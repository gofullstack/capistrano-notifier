...
module Capistrano
  module Notifier
    module V2
      class Mail < Capistrano::Notifier::V2::Base
          ...
          configuration.load do
            namespace :deploy do
              namespace :notify do
                ...
                task :mail do
                  Capistrano::Notifier::V2::Mail.new(configuration).perform
        ...
        def perform_with_legacy_action_mailer(notifier = Capistrano::Notifier::V2::Mailer)
          notifier.delivery_method = notify_method
          notifier.deliver_notice(text, from, subject, to, format)
        end

        def perform_with_action_mailer(notifier = Capistrano::Notifier::V2::Mailer)
...
if Capistrano::Configuration.instance
  Capistrano::Notifier::V2::Mail.load_into(Capistrano::Configuration.instance)
end
