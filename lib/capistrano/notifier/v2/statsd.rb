...
module Capistrano
  module Notifier
    module V2
      class StatsD < Capistrano::Notifier::V2::Base
          ...
          configuration.load do
            namespace :deploy do
              namespace :notify do
                ...
                task :statsd do
                  run Capistrano::Notifier::V2::StatsD.new(configuration).command
                end
              end
            end
...
if Capistrano::Configuration.instance
  Capistrano::Notifier::V2::StatsD.load_into(Capistrano::Configuration.instance)
end
